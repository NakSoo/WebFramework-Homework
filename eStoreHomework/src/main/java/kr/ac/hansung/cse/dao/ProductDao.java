...
public class ProductDao {
	...
	public List<Product> getProducts() {
		String sqlStaement = "select * from product";
		return jdbcTemplate.query(sqlStaement, new RowMapper<Product>() {
	...
	public Product getProductById(int id) {
		String sqlStaement = "select * from product where id=?";
		
		return jdbcTemplate.queryForObject(sqlStaement, new Object[] {id}, new RowMapper<Product>() {
